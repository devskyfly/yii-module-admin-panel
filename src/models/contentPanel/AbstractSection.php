...
abstract class AbstractSection extends AbstractItem
{
    ...
    public function deleteLikeItem()
    {
        ...
        //Event::trigger(static::class, static::EVENT_BEFORE_DELETE_LIKE_ITEM, new ItemEventMessage(['obj'=>$this]));
        ...
        //Event::trigger(static::class, static::EVENT_AFTER_DELETE_LIKE_ITEM, new ItemEventMessage(['obj'=>$this]));
        return true;
    }
